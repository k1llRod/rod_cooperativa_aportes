odoo.define('rod_cooperativa_aportes.partner_payroll', function (require) {
    "use strict";
    ...
    var PurchaseReport = AbstractAction.extend({
        ...
        start: function () {
            ...
            rpc.query({
                model: 'dynamic.report.partner.payroll',
                method: 'create',
                args: [{}]
            }).then(function (res) {
                console.log("TEST")
        ...
        load_data: function (initial_render = true) {
            ...
            self._rpc({
                ...
                if (initial_render) {
                    self.$('.filter_view_pr').html(QWeb.render('PartnerPayrollFilterView', {
                ...
                if (datas['orders'])
                    self.$('.table_view_pr').html(QWeb.render('PartnerPayrollTable', {
    ...
    core.action_registry.add("a_r", PurchaseReport);
